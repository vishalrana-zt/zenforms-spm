//
//  FPQueAnsCollectionViewLayout.swift
//  crm
//
...
final class FPQueAnsCollectionViewLayout: UICollectionViewLayout {
...
//
    ...
    override func layoutAttributesForItem(at indexPath: IndexPath) -> UICollectionViewLayoutAttributes? {
        ...
        //column: indexPath.row, row: indexPath.section
        ...
        case (0, 1):
            frame = CGRect(
                x:  CGFloat(WIDTH_HEADER_QUE_ANS) + originalContentOffset.x,
                y: (itemSize.height * CGFloat(indexPath.section))-delegate.heightOffset() + originalContentOffset.y,
                width: itemSize.width,
                height: itemSize.height
            )
        ...
        case (0, _):
            frame = CGRect(
                x:  (itemSize.width * CGFloat(indexPath.row))-(delegate.widthOffset()+CGFloat(WIDTH_HEADER_QUE_ANS)) + originalContentOffset.x,
                y: (itemSize.height * CGFloat(indexPath.section))-delegate.heightOffset() + originalContentOffset.y,
                width: itemSize.width,
                height: itemSize.height
            )
